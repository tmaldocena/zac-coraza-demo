...
import { CleanupCallback, ComponentDefinition, MapChannel, NodeMetadata, RenderCallback, ResizeCallback, UniformsMap, ToneMappingMode } from './types';
...
export declare function shaderRenderer(): {
    initialize: ({ canvas, resizeTarget, enablePerformanceTracking: enableTracking, colorSpace, toneMapping, context, gpu, forceFullFrameRate: forceFullFps, observeElement: shouldObserveElement }: InitializeOptions) => Promise<void>;
    cleanup: () => void;
