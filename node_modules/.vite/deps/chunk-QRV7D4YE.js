import {
  ShaderContext,
  componentDefinition79 as componentDefinition,
  createUniformsMap,
  setColorSpaceMode
} from "./chunk-UDDD6S4N.js";
import {
  require_jsx_runtime
...
// node_modules/shaders/dist/react/RectangularCoordinates.js
...
var ShaderComponent = (props) => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    try {
      Object.entries(uniformsRef.current).forEach(([propName, uniformData]) => {
        ...
        if ((uniform == null ? void 0 : uniform.value) !== void 0 && propName in effectiveProps) {
  ...
  const captureCanvas = isCapturesDOM && domMounted ? (0, import_react_dom.createPortal)((0, import_jsx_runtime.jsx)("canvas", {
  ...
  return (0, import_jsx_runtime.jsxs)(ShaderContext.Provider, {
...
var RectangularCoordinates_default2 = ShaderComponent;

export {
  ShaderComponent,
  RectangularCoordinates_default2 as RectangularCoordinates_default
};
//# sourceMappingURL=chunk-QRV7D4YE.js.map
